...
raw_data <- read.csv("/Users/husaynjessa/Documents/GitHub/HAD5744-Group-Project/1. Data/data.csv", 
...
analysis_data$money_concerned[analysis_data$money_concerned == "Completely"] <- "Yes"
analysis_data$money_concerned[analysis_data$money_concerned == "Very Well"] <- "Yes"
analysis_data$money_concerned[analysis_data$money_concerned == "Somewhat"] <- "Yes"
analysis_data$money_concerned[analysis_data$money_concerned == "Not at all"] <- "No"
analysis_data$money_concerned[analysis_data$money_concerned == "Very Little"] <- "No"
...
# Dwelling Ownership
analysis_data$own_rent[analysis_data$own_rent == "Own it with mortgage or loan (including condos)" ] <- "Cost Incurred from Housing"
analysis_data$own_rent[analysis_data$own_rent == 
                         "Rent it without subsidies, i.e. you pay a market rate"] <- "Cost Incurred from Housing"



analysis_data$own_rent[analysis_data$own_rent == "Part own and part rent (shared ownership such as co-op)" ] <- "Cost Incurred from Housing, Subsidized"
...
analysis_data$own_rent[analysis_data$own_rent == "Own it outright (including condos)" ] <- "No Cost Incurred from Housing"

analysis_data$own_rent[analysis_data$own_rent != "Cost Incurred from Housing" |
                         "Cost Incurred from Housing, Subsidized" |
                         "No Cost Incurred from Housing"] <- "No Cost Incurred from Housing"


                         
table(analysis_data$own_rent) 
