...
table(analysis_match_data$money_fetting_by,analysis_match_data$gad_clinical_cut)
gad_chi <- chisq.test(analysis_match_data$money_fetting_by,analysis_match_data$gad_clinical_cut)

 
table(analysis_match_data$money_fetting_by,analysis_match_data$phq_clinical_cut)
phq_chi <- chisq.test(analysis_match_data$money_fetting_by,analysis_match_data$phq_clinical_cut)
